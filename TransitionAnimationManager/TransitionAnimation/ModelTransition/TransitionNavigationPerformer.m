...
- (instancetype)initWithNav:(id)nav fromVc:(UIViewController *)fromVc toVc:(UIViewController *)toVc fromViewImg:(UIImageView *)fromViewImg toViewImg:(UIImageView *)toViewImg
{
    ...
    if (self) {
        ...
        // 初始化动画方案
        self.pushAnimation = [[TransitionPushAnimation alloc] init:fromVc toVc:toVc fromViewImg:fromViewImg toViewImg:toViewImg];
        self.popAnimation  = [[TransitionPopAnimation alloc] init:fromVc toVc:toVc fromViewImg:fromViewImg toViewImg:toViewImg];
    }
    return self;
}
