...
//    TransitionCell *cell =(TransitionCell*) [fromViewController.tableView cellForRowAtIndexPath:indexPath];
    ...
    UIView *cellImageSnapshot = [fromViewController.iconImageView snapshotViewAfterScreenUpdates:NO];
    cellImageSnapshot.frame = [containerView convertRect:fromViewController.iconImageView.frame fromView:fromViewController.iconImageView.superview];
